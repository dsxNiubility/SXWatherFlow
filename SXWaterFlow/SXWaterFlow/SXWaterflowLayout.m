...
#define SXCollectionW self.collectionView.frame.size.width
...
@implementation SXWaterflowLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // cell的宽度
    CGFloat w = (SXCollectionW - xMargin) / self.columnsCount;
    // cell的高度
